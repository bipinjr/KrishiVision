# 🌾 KrishiDrishti 3.0 + PestGuard

**KrishiDrishti 3.0 + PestGuard** is an AI-powered agriculture assistance prototype designed to help farmers make better decisions using intelligent analytics, automation, and agent-based pest monitoring.
...
**KrishiDrishti 3.0** addresses these challenges by providing a unified platform with intelligent modules and an agent-based system called **PestGuard**.
...
This project represents a **functional prototype and architectural skeleton** demonstrating the design and workflow of the KrishiDrishti system.
