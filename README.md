# 🌾 KrishiVision 3.0 + PestGuard

**KrishiVision 3.0 + PestGuard** is an AI-powered agriculture assistance prototype designed to help farmers make better decisions using intelligent analytics, automation, and agent-based pest monitoring.
...
**KrishiVision 3.0** addresses these challenges by providing a unified platform with intelligent modules and an agent-based system called **PestGuard**.
